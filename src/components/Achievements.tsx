...
const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'first_order', icon: Zap, name: 'Первый заказ', description: 'Получить первый заказ', color: 'text-gold', requirement: (s) => s.ordersCompleted >= 1 },
  { id: 'five_orders', icon: Star, name: 'В ритме', description: 'Выполнить 5 заказов', color: 'text-accent-amber', requirement: (s) => s.ordersCompleted >= 5 },
  ...
  { id: 'fifty_orders', icon: Crown, name: 'Мастер', description: 'Выполнить 50 заказов', color: 'text-gold', requirement: (s) => s.ordersCompleted >= 50 },
  ...
  { id: 'top_rating', icon: Star, name: 'Безупречный', description: 'Рейтинг 5.0', color: 'text-gold', requirement: (s) => s.rating >= 5.0 && s.reviewCount >= 3 },
  { id: 'high_rating', icon: Star, name: 'Высший класс', description: 'Рейтинг 4.8+', color: 'text-accent-amber', requirement: (s) => s.rating >= 4.8 && s.reviewCount >= 5 },
  ...
  { id: 'pro', icon: Target, name: 'PRO статус', description: 'Достичь PRO уровня', color: 'text-gold', requirement: (s) => s.level === 'pro' },
